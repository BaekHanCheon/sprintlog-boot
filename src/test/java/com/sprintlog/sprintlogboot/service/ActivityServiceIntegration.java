...
@SpringBootTest // Spring의 모든 빈을 등록해서 컨테이너에 세팅
@ActiveProfiles("test") // 테스트 실행 시 프로필 active를 test로 -> application-test.yml을 활성화 시킴
@DisplayName("ActivityService의 통합 테스트")
public class ActivityServiceIntegration {

  @Autowired //@SpringBootTest 설정때문에 가능
