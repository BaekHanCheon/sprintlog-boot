...
class JwtAuthenticationFilterTest {
  ...
  void 권한변경_인가_3종() {
    ...
    // 무토큰 → 401
    ResponseEntity<String> anonymous = rest.exchange(base + "/api/v1/auth/role",
    ...
    ResponseEntity<String> asUser = rest.exchange(base + "/api/v1/auth/role",
    ...
    ResponseEntity<String> asAdmin = rest.exchange(base + "/api/v1/auth/role",
