...
public class DataInitializer {
    ...
    public void loadSampleData() {
        ...
        if (userRepository.count() == 0) {
            ...
            User choon = new User("김춘식", "choon@naver.com", passwordEncoder.encode("password123"), Role.USER);
            ...
            User hong = new User("홍길동", "hong@gmail.com", passwordEncoder.encode("hong123"), Role.USER);
